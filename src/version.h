 ...
 */
#define DASM_PRINT_COPYRIGHT (void)puts("Copyright (c) 1988-2020 by the DASM team.");
 ...
 * usage messages.
 */
#define DASM_PRINT_BUGS (void)puts("Report bugs on https://github.com/dasm-assembler/dasm please!");
