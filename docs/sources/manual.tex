...
If provided with the second argument, the first <SkipBytes> bytes of the file will be excluded. This can be useful for skiping unwanted headers, e. g. load address indicators, SID tune headers, etc.\\
\hrule
