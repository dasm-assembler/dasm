...
\mono{}& %ANC#2
\mono{\color{ghost}\xmark}& % implied
\cellcolor{illegal}\mono{\$2B}& % immediate
\mono{\color{ghost}\xmark}& %zp
\mono{\color{ghost}\xmark}& %zp,x
\mono{\color{ghost}\xmark}& %abs
\mono{\color{ghost}\xmark}& %abs,x
...
\mono{BRK}&
\mono{ORA}&
\cellcolor{unstable}\mono{\color{ghost}---}&
...
\cellcolor{missing}\mono{NOP}&
\mono{TXA}&
\cellcolor{unimplemented}\mono{\color{ghost}---}&
\mono{STY}&
\mono{STA}&
\mono{STX}&
\cellcolor{illegal}\mono{SAX}
...
\mono{7}&
\mono{6}&
\cellcolor{unstable}$\infty$&
\cellcolor{illegal}\mono{8}&
\cellcolor{illegal}\mono{3}&
\mono{3}&
\mono{5}&
\cellcolor{illegal}\mono{5}&
\mono{3}&
\mono{2}&
\mono{2}&
\cellcolor{illegal}\mono{2}&
\cellcolor{illegal}\mono{4}&
\mono{4}&
\mono{6}&
\cellcolor{illegal}\mono{6}
\\
%\arrayrulecolor{ghost2}\hline
...
\cellcolor{illegal}\mono{2}&
\mono{2}&
\cellcolor{unimplemented}\mono{2}&
\mono{4}&
\mono{4}&
\mono{4}&
\cellcolor{illegal}\mono{4}
