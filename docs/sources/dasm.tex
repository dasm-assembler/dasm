...
\definecolor{brack}{rgb}{0.4,0.4,0.4}
...
% directives...	
		DC, dc, DS, ds, DV, dv%
		HEX, hex, BYTE, byte, WORD, word, LONG, long, B, b, W, w, L, l,
...
{\noindent\minipage{\linewidth}\medskip 
	\lstset{framesep=5pt,xleftmargin=5pt,xrightmargin=5pt,basicstyle=\ttfamily\small,morecomment=[n][\color{gray}]{;}{\^^M},frame=single}}
{\endminipage}

\lstnewenvironment{outputx}[1][]%
{\noindent\minipage{\linewidth}\medskip 
	\lstset{framesep=5pt,xleftmargin=5pt,xrightmargin=5pt,basicstyle=\ttfamily\small\color{yellow},morecomment=[n][\color{gray}]{;}{\^^M},frame=single,backgroundcolor=\color{black}}}
{\endminipage}

\lstnewenvironment{usage}[1][]%
{\noindent\minipage{\linewidth}\medskip 
	\lstset{framesep=5pt,xleftmargin=5pt,xrightmargin=5pt,basicstyle=\ttfamily\small,backgroundcolor=\color{pale},frame=single}}
{\endminipage}
